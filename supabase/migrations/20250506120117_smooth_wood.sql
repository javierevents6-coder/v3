/*
  ...
  This migration adds test transactions for income and expenses to help with testing
  the financial dashboard.

  1. Income transactions from various sources
  2. Expense transactions across different categories
  3. Transactions spread across different dates and banks
*/
